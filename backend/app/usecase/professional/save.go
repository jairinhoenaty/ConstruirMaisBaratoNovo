...
type SaveProfessionalUC struct {
	Service     pkgprofessional.ProfessionalService
	ServiceUser pkguser.UserService
	Assembler   *ProfessionalAssembler
}

type SaveProfessionalUCParams struct {
	Service     pkgprofessional.ProfessionalService
	ServiceUser pkguser.UserService
}

func NewSaveProfessionalUC(params SaveProfessionalUCParams) SaveProfessionalUC {
	return SaveProfessionalUC{
		Service:     params.Service,
		ServiceUser: params.ServiceUser,
	}
}

func (uc *SaveProfessionalUC) Execute() (*ProfessionalPresenter, error) {
