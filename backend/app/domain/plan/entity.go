...
type Plan struct {
	...
	// DurationDays é a vigência do plano em dias. Zero significa pagamento
	// avulso, sem expiração (ex: taxa por solicitação). Sem default no GORM:
	// um default faria o zero explícito do seed virar o valor padrão.
